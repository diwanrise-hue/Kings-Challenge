...
export const gameAI = {
    ...
    getWorkerInstance() {
        if (!this.workerInstance) {
            // ✅ السحر هنا: نستدعي الملف الحقيقي الموثوق بدلاً من Blob الممنوع
            this.workerInstance = new Worker('aiWorker.js');
        }
        ...
        return new Promise(async (resolve) => {
            ...
            try {
                if (window.Worker) {
                    ...
                    // ✅ قمنا بتقليل المهلة إلى 2 ثانية فقط كنوع من الحماية القصوى
